        ...
        <div>
          ...
          <ul class="mt-3">
            <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r" :class="isActive('/dashboard') && 'from-primary-500/[0.12] dark:from-primary-500/[0.24] to-primary-500/[0.04]'">
              <Link href="/dashboard" class="block text-gray-800 dark:text-gray-100 truncate transition" :class="isActive('/dashboard') ? '' : 'hover:text-gray-900 dark:hover:text-white'">
            ...
            <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r" :class="isActive('/fish') && 'from-primary-500/[0.12] dark:from-primary-500/[0.24] to-primary-500/[0.04]'">
            ...
            <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r" :class="isActive('/billing') && 'from-primary-500/[0.12] dark:from-primary-500/[0.24] to-primary-500/[0.04]'">
              <Link href="/billing" class="block text-gray-800 dark:text-gray-100 truncate transition" :class="isActive('/billing') ? '' : 'hover:text-gray-900 dark:hover:text-white'">
                <div class="flex items-center">
                  ...
                  <span class="text-lg lg:text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">PetriLog Abo</span>
                </div>
              </Link>
            </li>

            <li class="pl-4 pr-3 py-2 mt-5 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r" :class="isActive('/bug-report') && 'from-primary-500/[0.12] dark:from-primary-500/[0.24] to-primary-500/[0.04]'">
              <Link href="/bug-report" class="block text-gray-800 dark:text-gray-100 truncate transition" :class="isActive('/bug-report') ? '' : 'hover:text-gray-900 dark:hover:text-white'">
                <div class="flex items-center">
                  <BugAntIcon class="shrink-0 w-5 h-5" :class="isActive('/bug-report') ? 'text-primary-500' : 'text-gray-400 dark:text-gray-500'" />
                  <span class="text-lg lg:text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Fehler melden</span>
                </div>
              </Link>
            </li>

            <li v-if="$page.props.auth.user.isAdmin" class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r" :class="isActive('/admin') && 'from-primary-500/[0.12] dark:from-primary-500/[0.24] to-primary-500/[0.04]'">
              <Link href="/admin" class="block text-gray-800 dark:text-gray-100 truncate transition" :class="isActive('/admin') ? '' : 'hover:text-gray-900 dark:hover:text-white'">
                <div class="flex items-center">
                  <AdjustmentsHorizontalIcon class="shrink-0 w-5 h-5" :class="isActive('/admin') ? 'text-primary-500' : 'text-gray-400 dark:text-gray-500'" />
                  <span class="text-lg lg:text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Admin</span>
                </div>
              </Link>
            </li>
          </ul>
...
import { HomeIcon, BookmarkSquareIcon, PhotoIcon, WalletIcon, EyeIcon, StarIcon, BugAntIcon, AdjustmentsHorizontalIcon } from '@heroicons/vue/24/solid'
