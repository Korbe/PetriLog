...
return [
    ...
    "Kärnten" => [
        "link" => "/images/wappen/Kaernten.png",
        "wallpaper" => "/images/wallpaper/Kaernten.jpg",
        "name" => "Kärnten",
        ...
        "lakes" => [
            "Wörthersee" => ["link" => "/images/waters/Woerthersee.jpg"],
            "Faaker See" => ["link" => "/images/waters/Faakersee.jpeg"],
            "Ossiacher See" => ["link" => "/images/waters/Ossiachersee.jpeg"],
            "Millstätter See" => ["link" => "/images/waters/Millstättersee.jpeg"],
            "Falkertsee" => ["link" => "/images/waters/Falkertsee.jpeg"],
            "St.Urbaner See" => ["link" => "/images/waters/St. Urbaner See.jpeg"],
            "Talhofsee" => ["link" => "/images/waters/Talhofsee.jpeg"],
            "Grünsee" => ["link" => "/images/waters/Grünsee.jpeg"],
            "Keutschacher See" => ["link" => "/images/waters/Keutschacher See.jpeg"],
            "Rauschelesee" => ["link" => "/images/waters/Rauschelesee.jpeg"],
            "Spintikteich" => ["link" => "/images/waters/Spintikteich.jpeg"],
            "Mitterteich" => ["link" => "/images/waters/Mitterteich.jpeg"],
            "Weissensee" => ["link" => "/images/waters/Weissensee.jpeg"],
            "Afritzer See" => ["link" => "/images/waters/Afritzer See.jpeg"],
            "Brennsee" => ["link" => "/images/waters/Brennsee.jpeg"],
            "Kleinsee" => ["link" => "/images/waters/Kleinsee.jpeg"],
            "Klopeinersee" => ["link" => "/images/waters/Klopeinersee.jpeg"],
            "Turnersee" => ["link" => "/images/waters/Tunersee.jpeg"],
            "St. Andräer See" => ["link" => "/images/waters/St. Andräer See.jpeg"],
        ],
        "rivers" => [
            "Drau" => ["link" => "https://picsum.photos/200"],
            "Gail" => ["link" => "https://picsum.photos/200"],
            "Gurk" => ["link" => "https://picsum.photos/200"],
        ]
    ],

    "Steiermark" => [
        "link" => "/images/wappen/Steiermark.png",
        "wallpaper" => "/images/wallpaper/Steiermark.jpg",
        "name" => "Steiermark",
        ...
        "lakes" => [
            "Grundlsee" => ["link" => "/images/waters/Grundlsee.jpeg"],
            "Altausseersee" => ["link" => "/images/waters/Altausseersee.jpeg"],
            "Toplitzsee" => ["link" => "/images/waters/Toplitzsee.jpeg"],
        ],
        "rivers" => [
            "Mur" => ["link" => "/images/waters/Mur.jpeg"],
            "Enns" => ["link" => "/images/waters/Enns.jpeg"],
            "Lafnitz" => ["link" => "/images/waters/Lafnitz.jpg"],
        ]
    ],

    "Burgenland" => [
        "link" => "/images/wappen/Burgenland.png",
        "wallpaper" => "/images/wallpaper/Burgenland.jpg",
        "name" => "Burgenland",
        ...
        "lakes" => [
            "Neusiedler See" => ["link" => "/images/waters/Neusiedlersee.jpg"],
            "Zicksee" => ["link" => "/images/waters/Zicksee.jpeg"],
            "Stausee Rechnitz" => ["link" => "/images/waters/StauseeRechnitz.jpg"],
        ],
        "rivers" => [
            "Leitha" => ["link" => "/images/waters/Leitha.jpeg"],
            "Raab" => ["link" => "/images/waters/Raab.webp"],
        ]
    ],

    "Niederösterreich" => [
        "link" => "/images/wappen/Niederoesterreich.png",
        "wallpaper" => "/images/wallpaper/Niederoesterreich.jpg",
        ...
        "lakes" => [
            "Lunzersee" => ["link" => "/images/waters/Lunzersee.jpg"],
            "Erlaufsee" => ["link" => "/images/waters/Erlaufsee.jpeg"],
        ],
        "rivers" => [
            "Donau" => ["link" => "/images/waters/Donau.jpeg"],
            "Ybbs" => ["link" => "/images/waters/Ybbs.jpeg"],
            "Traisen" => ["link" => "/images/waters/Traisen.jpg"],
            "Thaya" => ["link" => "/images/waters/Thaya.jpeg"],
        ]
    ],

    "Oberösterreich" => [
        "link" => "/images/wappen/Oberoesterreich.png",
        "wallpaper" => "/images/wallpaper/Oberoesterreich.jpg",
        "name" => "Oberösterreich",
        ...
        "lakes" => [
            "Traunsee" => ["link" => "/images/waters/Traunsee.jpeg"],
            "Attersee" => ["link" => "/images/waters/Attersee.jpeg"],
            "Mondsee" => ["link" => "/images/waters/Mondsee.jpg"],
            "Wolfgangsee" => ["link" => "/images/waters/Wolfgangsee.jpeg"],
        ],
        "rivers" => [
            "Donau" => ["link" => "/images/waters/Donau.jpeg"],
            "Inn" => ["link" => "/images/waters/Inn.jpeg"],
            "Traun" => ["link" => "/images/waters/Traun.jpeg"],
            "Enns" => ["link" => "/images/waters/Enns.jpeg"],
        ]
    ],

    "Salzburg" => [
        "link" => "/images/wappen/Salzburg.png",
        "wallpaper" => "/images/wallpaper/Salzburg.jpg",
        "name" => "Salzburg",
        ...
        "lakes" => [
            "Zeller See" => ["link" => "/images/waters/Zellersee.jpeg"],
            "Fuschlsee" => ["link" => "/images/waters/Fuschlsee.jpeg"],
            "Wolfgangsee" => ["link" => "/images/waters/Wolfgangsee.jpeg"],
        ],
        "rivers" => [
            "Salzach" => ["link" => "/images/waters/Salzach.jpeg"],
            "Saalach" => ["link" => "/images/waters/Saalach.jpeg"],
        ]
    ],

    "Tirol" => [
        "link" => "/images/wappen/Tirol.png",
        "wallpaper" => "/images/wallpaper/Tirol.jpg",
        "name" => "Tirol",
        ...
        "lakes" => [
            "Achensee" => ["link" => "/images/waters/Achensee.jpeg"],
            "Piburger See" => ["link" => "/images/waters/Piburgersee.jpg"],
        ],
        "rivers" => [
            "Inn" => ["link" => "/images/waters/Inn.jpeg"],
            "Ötztaler Ache" => ["link" => "/images/waters/ÖtztalerAche.jpeg"],
            "Ziller" => ["link" => "/images/waters/Ziller.jpeg"],
        ]
    ],

    "Vorarlberg" => [
        "link" => "/images/wappen/Vorarlberg.png",
        "wallpaper" => "/images/wallpaper/Vorarlberg.jpg",
        "name" => "Vorarlberg",
        ...
        "lakes" => [
            "Bodensee" => ["link" => "/images/waters/Bodensee.jpeg"],
            "Formarinsee" => ["link" => "/images/waters/Formarinsee.jpeg"],
            "Lünersee" => ["link" => "/images/waters/Lünersee.jpeg"],
        ],
        "rivers" => [
            "Ill" => ["link" => "/images/waters/Ill.jpeg"],
            "Bregenzerach" => ["link" => "https://picsum.photos/200"],
        ]
    ],

    "Wien" => [
        "link" => "/images/wappen/Wien.png",
